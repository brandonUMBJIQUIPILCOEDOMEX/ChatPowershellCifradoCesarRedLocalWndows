...
<Window
    xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation'
    xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml'
    x:Name="Window" Title="Chat powershell con cifrado cesar" Height="400" Width="550" WindowStartupLocation="CenterScreen" ShowInTaskbar="True">    
    <Window.Background>
        <LinearGradientBrush StartPoint='0,0' EndPoint='0,1'>
            <LinearGradientBrush.GradientStops> <GradientStop Color='#C4CBD8' Offset='0' /> <GradientStop Color='#E6EAF5' Offset='0.2' /> 
            <GradientStop Color='#CFD7E2' Offset='0.9' /> <GradientStop Color='#C4CBD8' Offset='1' /> </LinearGradientBrush.GradientStops>
    ...
    <Grid ShowGridLines = 'true'> 
        <Grid.ColumnDefinitions>
            <ColumnDefinition Width ='175*'> </ColumnDefinition>  <!-- tenia 175-->
            <ColumnDefinition Width ='Auto'> </ColumnDefinition>
            <ColumnDefinition Width ='75*'> </ColumnDefinition>    <!-- tenia 75-->
        ...
        <Grid.RowDefinitions>
            ...
            <RowDefinition Height = '10'/>    <!-- tenia 10-->
            <RowDefinition Height = '105'/>   <!-- tenia 80-->
            <RowDefinition Height = '50'/>   <!-- tenia 80 esta la agregue yo-->
        </Grid.RowDefinitions>  
        
         
       <Menu Width = 'Auto' HorizontalAlignment = 'Stretch' Grid.Row = '0' Grid.ColumnSpan = '4'>  <!-- Grid.ColumnSpan tenia 3-->
        <Menu.Background>
            <LinearGradientBrush StartPoint='0,0' EndPoint='0,1'>
                <LinearGradientBrush.GradientStops> <GradientStop Color='#C4CBD8' Offset='0' /> <GradientStop Color='#E6EAF5' Offset='0.2' /> 
                <GradientStop Color='#CFD7E2' Offset='0.9' /> <GradientStop Color='#C4CBD8' Offset='1' /> </LinearGradientBrush.GradientStops>
        ...
        <Grid Grid.Column = '0' Grid.Row = '3' ShowGridLines = 'false'>    <!-- true -->
        <Grid.ColumnDefinitions>
        ...
        <Grid Grid.Column = '2' Grid.Row = '3' ShowGridLines = 'true'>  <!-- estaba en false-->
            <Grid.ColumnDefinitions>
                <ColumnDefinition Width ='Auto'> </ColumnDefinition>
            ...
            <Label Content = 'Dezplaza' HorizontalAlignment = 'Stretch' Grid.Column = '0' Grid.Row = '2'/>
            <TextBox x:Name = 'dezplazacezar_txt' HorizontalAlignment = 'Stretch' Grid.Column = '2' Grid.Row = '2'/>   
            ...
            Grid.Column = '2' Grid.Row = '3' HorizontalAlignment = 'stretch' IsEnabled = 'False'/>
...
$dezplazacezar_txtn = $Window.FindName('dezplazacezar_txt')
...
$ConnectButton.Add_Click({    
    ...
    # desplazamiento cezzar
    $dcezzar = $dezplazacezar_txtn.text
    
    #Get Username
    $Global:Username = $Username_txt.text

    #dezplazamiento cezzar


    If ($username -match "^[A-Za-z0-9_!]*$") {   
        $ConnectButton.IsEnabled = $False
        $DisconnectButton.IsEnabled = $True     
        If ($Server -AND $Username -AND $dcezzar) {        
            ...
            Try {
                ...
                # antes de escribir debe encriptar
...
$SendButton.Add_Click({
    ...
    $msgEncripted= cezzar "e" $dezplazacezar_txtn.Text $Inputbox_txt.Text
    Write-Host "$msgEncripted"
    $Message = "~M{0}{1}{2}" -f $username,"~~",$msgEncripted
   
    $data = [text.Encoding]::Ascii.GetBytes($Message)

    # cifrado cezzar encripta
   

    #$msgD = cezzar "d" 4 $data 
...
# cifrado ceszar metodo de encriptacion y desencriptacion 
        ...
        If ($Messagequeue.Count -gt 0) {
            ...
            Switch ($Message) {
                ...
                {$_.Startswith("~M")} {
                    ...
                    $aux = $split[1]
                    $msgDecripted1= cezzar "d" $dezplazacezar_txtn.Text $aux


                    $Paragraph.Inlines.Add((New-ChatMessage -Message ("{0}" -f $msgDecripted1) -ForeGround Black))
                }
                {$_.Startswith("~D")} {
                    #Disconnect
                    $Paragraph.Inlines.Add((New-ChatMessage -Message ("[{0}] " -f (Get-Date).ToLongTimeString()) -ForeGround Gray))
